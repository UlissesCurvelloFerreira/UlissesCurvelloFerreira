...
<table>
  <tr>
    <td>
      <a href="https://github.com/UlissesCurvelloFerreira/Sistemas_Operacionais_CI1215">
        📌 Sistemas Operacionais
      </a>
    </td>
    <td>Projects and activities from the Operating Systems course.</td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/UlissesCurvelloFerreira/Materias_UFPR/tree/main/AprendizadoMaquina">
        📌 Aprendizado de Máquina
      </a>
    </td>
    <td>Activities and studies related to Machine Learning.</td>
  </tr>
  <tr>
    <td>
      <a href="https://github.com/UlissesCurvelloFerreira/Materias_UFPR/tree/main/Prog2">
        📌 Programação 2
      </a>
    </td>
    <td>Assignments and exercises from the Programming 2 course.</td>
  </tr>
</table>
...
<div style="display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #30363d;border-radius:10px;padding:12px 16px;margin-bottom:10px;background:#161b22;"><div style="display:flex;align-items:center;gap:10px;"><span style="background:#1f6feb;color:#fff;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:bold;white-space:nowrap;min-width:150px;text-align:center;overflow:hidden;text-overflow:ellipsis;display:inline-block;">commit</span><span style="color:#c9d1d9;font-size:14px;">em <a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira" style="color:#58a6ff;text-decoration:underline;">UlissesCurvelloFerreira/UlissesCurvelloFerreira</a></span></div><a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira"><img src="https://img.shields.io/badge/Ver_reposit%C3%B3rio-1f6feb?style=for-the-badge&logo=github&logoColor=white"/></a></div>
<div style="display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #30363d;border-radius:10px;padding:12px 16px;margin-bottom:10px;background:#161b22;"><div style="display:flex;align-items:center;gap:10px;"><span style="background:#1f6feb;color:#fff;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:bold;white-space:nowrap;min-width:150px;text-align:center;overflow:hidden;text-overflow:ellipsis;display:inline-block;">commit</span><span style="color:#c9d1d9;font-size:14px;">em <a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira" style="color:#58a6ff;text-decoration:underline;">UlissesCurvelloFerreira/UlissesCurvelloFerreira</a></span></div><a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira"><img src="https://img.shields.io/badge/Ver_reposit%C3%B3rio-1f6feb?style=for-the-badge&logo=github&logoColor=white"/></a></div>
<div style="display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #30363d;border-radius:10px;padding:12px 16px;margin-bottom:10px;background:#161b22;"><div style="display:flex;align-items:center;gap:10px;"><span style="background:#1f6feb;color:#fff;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:bold;white-space:nowrap;min-width:150px;text-align:center;overflow:hidden;text-overflow:ellipsis;display:inline-block;">commit</span><span style="color:#c9d1d9;font-size:14px;">em <a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira" style="color:#58a6ff;text-decoration:underline;">UlissesCurvelloFerreira/UlissesCurvelloFerreira</a></span></div><a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira"><img src="https://img.shields.io/badge/Ver_reposit%C3%B3rio-1f6feb?style=for-the-badge&logo=github&logoColor=white"/></a></div>
<div style="display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #30363d;border-radius:10px;padding:12px 16px;margin-bottom:10px;background:#161b22;"><div style="display:flex;align-items:center;gap:10px;"><span style="background:#1f6feb;color:#fff;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:bold;white-space:nowrap;min-width:150px;text-align:center;overflow:hidden;text-overflow:ellipsis;display:inline-block;">commit</span><span style="color:#c9d1d9;font-size:14px;">em <a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira" style="color:#58a6ff;text-decoration:underline;">UlissesCurvelloFerreira/UlissesCurvelloFerreira</a></span></div><a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira"><img src="https://img.shields.io/badge/Ver_reposit%C3%B3rio-1f6feb?style=for-the-badge&logo=github&logoColor=white"/></a></div>
<div style="display:flex;align-items:center;justify-content:space-between;gap:12px;border:1px solid #30363d;border-radius:10px;padding:12px 16px;margin-bottom:10px;background:#161b22;"><div style="display:flex;align-items:center;gap:10px;"><span style="background:#1f6feb;color:#fff;padding:4px 10px;border-radius:20px;font-size:12px;font-weight:bold;white-space:nowrap;min-width:150px;text-align:center;overflow:hidden;text-overflow:ellipsis;display:inline-block;">commit</span><span style="color:#c9d1d9;font-size:14px;">em <a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira" style="color:#58a6ff;text-decoration:underline;">UlissesCurvelloFerreira/UlissesCurvelloFerreira</a></span></div><a href="https://github.com/UlissesCurvelloFerreira/UlissesCurvelloFerreira"><img src="https://img.shields.io/badge/Ver_reposit%C3%B3rio-1f6feb?style=for-the-badge&logo=github&logoColor=white"/></a></div>
